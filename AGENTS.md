# Science Pupil's Book Standard Three — ADT Bundle Reference
...
**Science Pupil's Book Standard Three** — This is an English-language primary science textbook from Tanzania, published by the Tanzania Institute of Education for Standard Three pupils, roughly equivalent to early elementary/Grade 3 level. It introduces basic science concepts such as the meaning and branches of science, sense organs, living and non-living things, simple scientific investigations, and introductory ICT-based learning games. The book uses a child-friendly, activity-based approach with illustrations, questions, experiments, exercises, and vocabulary sections to build observation, inquiry, problem-solving, and everyday life application skills.
...
├── SCIENCE-PUPILS-BOOK-STD-3.db                    # SQLite database (pipeline state)
├── SCIENCE-PUPILS-BOOK-STD-3.pdf                   # Original source PDF
...
```json
{
  "absorb": {
    "word": "absorb",
    "definition": "to take in or soak up something such as water or nutrients",
    "variations": ["absorb","absorbs","absorbed","absorbing"],
    "emoji": "💧🌱"
  }
}
```
...
```json
{
  "title": "Science Pupil's Book Standard Three",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en"
...
| Original PDF | `SCIENCE-PUPILS-BOOK-STD-3.pdf` |
| Pipeline database | `SCIENCE-PUPILS-BOOK-STD-3.db` (SQLite) |
